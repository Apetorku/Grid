        ...
        <CardContent>
          ...
          <div className="relative my-4">
            <div className="absolute inset-0 flex items-center">
              <span className="w-full border-t border-slate-border" />
            </div>
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-slate-panel px-2 text-slate-400">
                Or continue with
              </span>
            </div>
          </div>
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full border-slate-border text-white hover:border-electric-blue hover:bg-slate-card"
